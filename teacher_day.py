...
def home():
    ...
    default_message = "Chúc mừng Ngày Nhà giáo Việt Nam 20/11! Lớp 11A6 Kính chúc Thầy/Cô luôn mạnh khỏe, hạnh phúc và thành công trong sự nghiệp trồng người!,chúc thầy/cô 8386!"
...
<div class="container">
  ...
  <div class="container">
    <button id="chucmung" class="btn btn-primary">Nhấn vào đây</button>
  </div>

  <script>
  document.addEventListener("DOMContentLoaded", function() {
      document.getElementById("chucmung").addEventListener()"click", function() {
          alert("🎉 Chúc mừng Ngày Nhà giáo Việt Nam 20/11!\Kính chúc Thầy/Cô luôn mạnh khỏe, hạnh phúc và có 1 ngày 20/11 vui vẻ!");
      });
  });
  </script>
  <script>
        document.getElementById("chucmung").addEventListener("click", function() {
            alert("🎉 Chúc mừng Ngày Nhà giáo Việt Nam 20/11!\\Kính chúc Thầy/Cô luôn mạnh khỏe, hạnh phúc và dẫn dắt bọn em trên con đường tiếp theo!")
        });
</script>
